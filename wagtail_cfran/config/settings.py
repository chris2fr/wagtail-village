"""
Django settings for wagtail_cfran project.
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "wagtail_cfran.context_processors.skiplinks",
                "wagtail_cfran.context_processors.mega_menus",
            ],
        },
    },
]

WSGI_APPLICATION = "wagtail_cfran.config.wsgi.application"
