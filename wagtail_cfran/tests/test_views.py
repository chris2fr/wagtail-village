...
from wagtail_cfran.models import ContentPage, MegaMenu, MegaMenuCategory, WagtailCfranConfig
...
class ConfigTestCase(WagtailPageTestCase):
    def setUp(self):
        ...
        self.config, _created = WagtailCfranConfig.objects.update_or_create(
            site_id=1,
            defaults={
    ...
    def test_header_brand_block_uses_conf(self):
        ...
        self.assertInHTML(
            """<a href="/"
                ...
                <p class="cfran-logo">République<br />française</p>
            </a>""",
    ...
    def test_footer_brand_block_uses_conf(self):
        ...
        self.assertInHTML(
            """<div class="cfran-footer__brand cfran-enlarge-link">
    ...
    def test_header_title_block_uses_conf(self):
        ...
        self.assertInHTML(
            """<div class="cfran-header__service">
                <a href="/" title="Accueil — Site title">
                    <p class="cfran-header__service-title">Site title</p>
                </a>
                <p class="cfran-header__service-tagline">Site tagline</p>
            </div>""",
            response.content.decode(),
        )
    ...
    def test_notice_can_be_set(self):
        ...
        self.assertInHTML(
            """<div class="cfran-notice cfran-notice--info">
    ...
    def test_footer_description_uses_conf(self):
        ...
        self.assertInHTML(
            """<p class="cfran-footer__content-desc">
...
class MenusTestCase(WagtailPageTestCase):
    ...
    def test_basic_menu_is_rendered(self):
        ...
        self.assertInHTML(
            '<a class="cfran-nav__link" href="/" aria-current="page" target="_self">Accueil</a>',
            response.content.decode(),
        )

        self.assertInHTML(
            f"""<button class="cfran-nav__btn"
                aria-expanded="false"
        ...
        self.assertInHTML(
            '<a class="cfran-nav__link" href="/publications/publication-1/" target="_self">Publication 1</a>',
            response.content.decode(),
        )
        ...
        self.assertInHTML(
            '<a class="cfran-nav__link" href="/" target="_self">Accueil</a>',
            response.content.decode(),
        )
    ...
    def test_mega_menu_is_rendered(self):
        ...
        self.assertInHTML(
            '<p class="cfran-hidden cfran-displayed-lg">Ceci est une description</p>',
            response.content.decode(),
        )
