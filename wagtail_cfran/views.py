...
from wagtail_cfran.models import ContentPage, Tag


class SearchResultsView(ListView):
    model = ContentPage
    template_name = "wagtail_cfran/search_results.html"
...
class TagsListView(TemplateView):
    template_name = "wagtail_cfran/tags_list_page.html"
...
class TagView(ListView):
    template_name = "wagtail_cfran/tag_page.html"
    model = ContentPage
    paginate_by = 10
