...
from django_fastoche.constants import COLOR_CHOICES, COLOR_CHOICES_ILLUSTRATION, COLOR_CHOICES_SYSTEM
from wagtail import blocks
from wagtail.documents.blocks import DocumentChooserBlock
from wagtail.images.blocks import ImageChooserBlock
from wagtailmarkdown.blocks import MarkdownBlock

from wagtail_cfran.constants import HEADING_CHOICES, LEVEL_CHOICES
...
class IconPickerBlock(blocks.FieldBlock):
    ...
    @cached_property
    def field(self):
        field_kwargs = {"widget": WagtailCfranIconPickerWidget()}
...
class BadgeBlock(blocks.StructBlock):
    ...
    class Meta:
        template = ("wagtail_cfran/blocks/badge.html",)
...
class BadgesListBlock(blocks.StreamBlock):
    ...
    class Meta:
        icon = "list-ul"
        template = "wagtail_cfran/blocks/badges_list.html"
...
class TagBlock(blocks.StructBlock):
    ...
    class Meta:
        template = "wagtail_cfran/blocks/tag.html"
...
class TagListBlock(blocks.StreamBlock):
    ...
    class Meta:
        icon = "list-ul"
        template = "wagtail_cfran/blocks/tags_list.html"
...
class CardBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "tablet-alt"
        template = "wagtail_cfran/blocks/card.html"
...
class IframeBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "globe"
        template = "wagtail_cfran/blocks/iframe.html"
...
class ImageAndTextBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "image"
        template = "wagtail_cfran/blocks/image_and_text.html"
...
class ImageBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "image"
        template = "wagtail_cfran/blocks/image.html"
...
class QuoteBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "openquote"
        template = "wagtail_cfran/blocks/quote.html"
...
class TextAndCTA(blocks.StructBlock):
    ...
    class Meta:
        icon = "link"
        template = "wagtail_cfran/blocks/text_and_cta.html"
...
class VideoBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "media"
        template = "wagtail_cfran/blocks/video.html"
...
class MultiColumnsWithTitleBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "dots-horizontal"
        template = "wagtail_cfran/blocks/multicolumns.html"
...
class FullWidthBackgroundBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "minus"
        template = "wagtail_cfran/blocks/full_width_background.html"
