...
# from sites_faciles.abstract import SitesFacilesBasePage
from sites_faciles.models import ContentPage, Tag
from sites_faciles_blog.blocks import COLOPHON_BLOCKS
from sites_faciles_blog.managers import CategoryManager
...
class BlogIndexPage(ContentPage):
    ...
    subpage_types = ["sites_faciles_blog.BlogEntryPage", "sites_faciles_blog.DirectoryEntryPage"]
...
class DirectoryIndexPage(BlogIndexPage):
    ...
    subpage_types = ["sites_faciles_blog.DirectoryEntryPage"]
...
class BlogEntryPage(ContentPage):
    ...
    parent_page_types = ["sites_faciles_blog.BlogIndexPage", "sites_faciles_blog.DirectoryIndexPage"]
    subpage_types = []
...
class DirectoryEntryPage(BlogEntryPage):
    ...
    parent_page_types = ["sites_faciles_blog.DirectoryIndexPage"]
