...
from wagtail_cefran.models import ContentPage
from wagtail_cefran.utils import get_or_create_footer_menu, import_image
...
class Command(BaseCommand):
    ...
    def create_homepage(self) -> None:
        ...
        image_and_text_block = {
            ...
            "link": {"external_url": "https://www.cefran.org", "text": "Cefran !"},
        }
