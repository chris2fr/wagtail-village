...
from wagtail_cefran.models import ContentPage, Tag
...
class SearchResultsView(ListView):
    model = ContentPage
    template_name = "wagtail_cefran/search_results.html"
...
class TagsListView(TemplateView):
    template_name = "wagtail_cefran/tags_list_page.html"
...
class TagView(ListView):
    template_name = "wagtail_cefran/tag_page.html"
    model = ContentPage
    paginate_by = 10
