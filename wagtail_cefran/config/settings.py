"""
Django settings for wagtail_cefran project.
...
INSTALLED_APPS = [
    ...
    "widget_tweaks",
    "django_cefran.cefran_lesgrandsvoisins",
    "django_cefran.cefran_designsystem",
    "django_cefran",
    "sass_processor",
    "wagtail_cefran",
    "wagtail_cefran.dashboard",
    "wagtail_cefran.blog",
]
...
ROOT_URLCONF = "wagtail_cefran.config.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [
            os.path.join(BASE_DIR, "django_cefran/templates"),
...
WSGI_APPLICATION = "wagtail_cefran.config.wsgi.application"
