...
from django_cefran.constants import COLOR_CHOICES, COLOR_CHOICES_ILLUSTRATION, COLOR_CHOICES_SYSTEM
from wagtail import blocks
from wagtail.documents.blocks import DocumentChooserBlock
from wagtail.images.blocks import ImageChooserBlock
from wagtailmarkdown.blocks import MarkdownBlock

from wagtail_cefran.constants import HEADING_CHOICES, LEVEL_CHOICES
from wagtail_cefran.widgets import WagtailCefranIconPickerWidget
...
class IconPickerBlock(blocks.FieldBlock):
    ...
    @cached_property
    def field(self):
        field_kwargs = {"widget": WagtailCefranIconPickerWidget()}
...
class BadgeBlock(blocks.StructBlock):
    ...
    class Meta:
        template = ("wagtail_cefran/blocks/badge.html",)
...
class BadgesListBlock(blocks.StreamBlock):
    ...
    class Meta:
        icon = "list-ul"
        template = "wagtail_cefran/blocks/badges_list.html"
...
class TagBlock(blocks.StructBlock):
    ...
    class Meta:
        template = "wagtail_cefran/blocks/tag.html"
...
class TagListBlock(blocks.StreamBlock):
    ...
    class Meta:
        icon = "list-ul"
        template = "wagtail_cefran/blocks/tags_list.html"
...
class CardBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "tablet-alt"
        template = "wagtail_cefran/blocks/card.html"
...
class IframeBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "globe"
        template = "wagtail_cefran/blocks/iframe.html"
...
class ImageAndTextBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "image"
        template = "wagtail_cefran/blocks/image_and_text.html"
...
class ImageBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "image"
        template = "wagtail_cefran/blocks/image.html"
...
class QuoteBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "openquote"
        template = "wagtail_cefran/blocks/quote.html"
...
class TextAndCTA(blocks.StructBlock):
    ...
    class Meta:
        icon = "link"
        template = "wagtail_cefran/blocks/text_and_cta.html"
...
class VideoBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "media"
        template = "wagtail_cefran/blocks/video.html"
...
class MultiColumnsWithTitleBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "dots-horizontal"
        template = "wagtail_cefran/blocks/multicolumns.html"
...
class FullWidthBackgroundBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "minus"
        template = "wagtail_cefran/blocks/full_width_background.html"
