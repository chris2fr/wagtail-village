...
from wagtail_cefran.models import ContentPage, MegaMenu, MegaMenuCategory, WagtailCefranConfig
...
class ConfigTestCase(WagtailPageTestCase):
    def setUp(self):
        ...
        self.config, _created = WagtailCefranConfig.objects.update_or_create(
            site_id=1,
            defaults={
    ...
    def test_header_brand_block_uses_conf(self):
        ...
        self.assertInHTML(
            """<a href="/"
                ...
                <p class="cefran-logo">République<br />française</p>
            </a>""",
    ...
    def test_footer_brand_block_uses_conf(self):
        ...
        self.assertInHTML(
            """<div class="cefran-footer__brand cefran-enlarge-link">
        ...
        self.assertInHTML(
            """<div class="cefran-header__service">
                <a href="/" title="Accueil — Site title">
                    <p class="cefran-header__service-title">Site title</p>
                </a>
                <p class="cefran-header__service-tagline">Site tagline</p>
            </div>""",
            response.content.decode(),
        )
    ...
    def test_notice_can_be_set(self):
        ...
        self.assertInHTML(
            """<div class="cefran-notice cefran-notice--info">
    ...
    def test_footer_description_uses_conf(self):
        ...
        self.assertInHTML(
            """<p class="cefran-footer__content-desc">
...
class MenusTestCase(WagtailPageTestCase):
    ...
    def test_basic_menu_is_rendered(self):
        ...
        self.assertInHTML(
            '<a class="cefran-nav__link" href="/" aria-current="page" target="_self">Accueil</a>',
            response.content.decode(),
        )

        self.assertInHTML(
            f"""<button class="cefran-nav__btn"
                aria-expanded="false"
        ...
        self.assertInHTML(
            '<a class="cefran-nav__link" href="/publications/publication-1/" target="_self">Publication 1</a>',
            response.content.decode(),
        )
        ...
        self.assertInHTML(
            '<a class="cefran-nav__link" href="/" target="_self">Accueil</a>',
            response.content.decode(),
        )
    ...
    def test_mega_menu_is_rendered(self):
        ...
        self.assertInHTML(
            '<p class="cefran-hidden cefran-displayed-lg">Ceci est une description</p>',
            response.content.decode(),
        )
