...
from sites_faciles.sites_faciles_blog.models import BlogEntryPage, BlogIndexPage, Category
...
class CategoriesListView(TemplateView):
    template_name = "sites_faciles_blog/categories_list_page.html"
...
class TagsListView(TemplateView):
    template_name = "sites_faciles_blog/tags_list_page.html"
