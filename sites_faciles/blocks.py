...
from django_design_system.constants import COLOR_CHOICES, COLOR_CHOICES_ILLUSTRATION, COLOR_CHOICES_SYSTEM
from sites_faciles.constants import HEADING_CHOICES, LEVEL_CHOICES
...
class IconPickerBlock(blocks.FieldBlock):
    ...
    @cached_property
    def field(self):
        field_kwargs = {"widget": WagtailSitesFacilesIconPickerWidget()}
...
class BadgeBlock(blocks.StructBlock):
    ...
    class Meta:
        template = ("sites_faciles/blocks/badge.html",)
...
class BadgesListBlock(blocks.StreamBlock):
    ...
    class Meta:
        icon = "list-ul"
        template = "sites_faciles/blocks/badges_list.html"
...
class TagBlock(blocks.StructBlock):
    ...
    class Meta:
        template = "sites_faciles/blocks/tag.html"
...
class TagListBlock(blocks.StreamBlock):
    ...
    class Meta:
        icon = "list-ul"
        template = "sites_faciles/blocks/tags_list.html"
...
class CardBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "tablet-alt"
        template = "sites_faciles/blocks/card.html"
...
class GradientBlock(blocks.StructBlock):
    ...
    class Meta:
        template = "sites_faciles/blocks/gradient.html"
...
class IframeBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "globe"
        template = "sites_faciles/blocks/iframe.html"
...
class ImageAndTextBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "image"
        template = "sites_faciles/blocks/image_and_text.html"
...
class ImageBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "image"
        template = "sites_faciles/blocks/image.html"
...
class QuoteBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "openquote"
        template = "sites_faciles/blocks/quote.html"
...
class TextAndCTA(blocks.StructBlock):
    ...
    class Meta:
        icon = "link"
        template = "sites_faciles/blocks/text_and_cta.html"
...
class VideoBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "media"
        template = "sites_faciles/blocks/video.html"
...
class MultiColumnsWithTitleBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "dots-horizontal"
        template = "sites_faciles/blocks/multicolumns.html"
...
class FullWidthBackgroundBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "minus"
        template = "sites_faciles/blocks/full_width_background.html"
