...
from sites_faciles.sites_faciles_page.models import ContentPage, SitesFacilesBasePage, WagtailSitesFacilesConfig
...
class FormField(AbstractFormField):
    ...
    def get_field(self):
        ...
        if self.field_type == "radio":
            print("SitesFacilesRadioSelect")
            return forms.ChoiceField(
                label=self.label,
                required=self.required,
                help_text=self.help_text,
                widget=SitesFacilesRadioSelect,
