...
from django_dsfacile.constants import DJANGO_DSFACILE_LANGUAGES
...
class DsfacileConfig(models.Model):
    ...
    def social_media(self):
        return self.dsfacilesocialmedia_set.all()


class DsfacileSocialMedia(models.Model):
    site_config = models.ForeignKey(DsfacileConfig, on_delete=models.CASCADE, null=True)
