...
class Migration(migrations.Migration):
    ...
    def getSQLRenameContentManagerQuery(name_from, name_to):
        ...
        sql_query = (
            "UPDATE django_content_type SET app_label='{}_bak' WHERE app_label='{}';".format(name_to, name_to),
    ...
    if result_wagtail_fastoche:
        sql_query = getSQLRenameContentManagerQuery("wagtail_cfran", "wagtail_fastoche") + getSQLRenameDSFRQuery(
            "wagtail_cfran", "wagtail_fastoche"
        )
        reverse_sql_query = getSQLRenameContentManagerQuery(
            "wagtail_fastoche", "wagtail_cfran"
        ) + getSQLRenameDSFRQuery("wagtail_fastoche", "wagtail_cfran")
        operations = [
