...
from wagtail_fastoche.abstract import SitesFacilesBasePage, WagtailFastocheConfig
...
class MegaMenuCategory(Orderable):
    mega_menu = ParentalKey("wagtail_fastoche.MegaMenu", related_name="categories", on_delete=models.CASCADE)
