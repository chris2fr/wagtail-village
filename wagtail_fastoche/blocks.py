...
class BadgeBlock(blocks.StructBlock):
    ...
    class Meta:
        template = ("wagtail_fastoche/blocks/badge.html",)
...
class BadgesListBlock(blocks.StreamBlock):
    ...
    class Meta:
        icon = "list-ul"
        template = "wagtail_fastoche/blocks/badges_list.html"
...
class TagBlock(blocks.StructBlock):
    ...
    class Meta:
        template = "wagtail_fastoche/blocks/tag.html"
...
class TagListBlock(blocks.StreamBlock):
    ...
    class Meta:
        icon = "list-ul"
        template = "wagtail_fastoche/blocks/tags_list.html"
...
class CardBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "tablet-alt"
        template = "wagtail_fastoche/blocks/card.html"
...
class IframeBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "globe"
        template = "wagtail_fastoche/blocks/iframe.html"
...
class ImageAndTextBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "image"
        template = "wagtail_fastoche/blocks/image_and_text.html"
...
class ImageBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "image"
        template = "wagtail_fastoche/blocks/image.html"
...
class QuoteBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "openquote"
        template = "wagtail_fastoche/blocks/quote.html"
...
class TextAndCTA(blocks.StructBlock):
    ...
    class Meta:
        icon = "link"
        template = "wagtail_fastoche/blocks/text_and_cta.html"
...
class VideoBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "media"
        template = "wagtail_fastoche/blocks/video.html"
...
class MultiColumnsWithTitleBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "dots-horizontal"
        template = "wagtail_fastoche/blocks/multicolumns.html"
...
class FullWidthBackgroundBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "minus"
        template = "wagtail_fastoche/blocks/full_width_background.html"
